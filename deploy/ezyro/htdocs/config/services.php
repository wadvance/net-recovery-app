...
return [
    ...
    */
    ...
    'ycloud' => [
        'api_key' => env('YCLOUD_API_KEY', '45b6576accd93176b13c2edb9b9273ca'),
        'phone_number_id' => env('YCLOUD_PHONE_NUMBER_ID', '1324615497397442'),
        'waba_id' => env('YCLOUD_WABA_ID', '941546828270634'),
        'base_url' => env('YCLOUD_API_URL', 'https://api.ycloud.com'),
        'version' => env('YCLOUD_VERSION', 'v1'),
    ],
